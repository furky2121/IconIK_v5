...
namespace IconIK.API.Migrations
{
    ...
    [Migration("20250914133202_IseAlimModulu")]
    partial class IseAlimModulu
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BilgeLojistikIK.API.Models.Basvuru", b =>
                {
                    ...
                    b.HasIndex("DegerlendireId");

                    b.HasIndex("IlanId");

                    b.ToTable("basvurular", t =>
                        {
                            t.HasCheckConstraint("CK_Basvuru_Durum", "durum IN (1, 2, 3, 4, 5, 6, 7, 8)");
                        });
                });
